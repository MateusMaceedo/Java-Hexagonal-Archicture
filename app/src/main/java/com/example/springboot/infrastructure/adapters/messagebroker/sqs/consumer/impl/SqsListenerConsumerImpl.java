...
import com.example.springboot.infrastructure.adapters.messagebroker.sqs.consumer.Consumer;
...
@Component
@AllArgsConstructor
public class SqsListenerConsumerImpl implements Consumer {

    private static final Logger logger = LoggerFactory.getLogger(SqsListenerConsumerImpl.class);
